...
- for `mode=single`: generate one Task issue body at `plans/YYYY-MM-DD/task-<feature-slug>-01.md` (or under `plans/YYYY-MM-DD/<workstream-slug>/` when co-locating multiple artifacts) and run `gh issue create`
